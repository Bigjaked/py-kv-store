...
cdef class CacheDummy:
    ...
    cdef object _get(self, str key): return ''
    cdef object get(self, str key): return ''
...
cdef class LRUCache:
    ...
    cdef void set_(self, object key_, object value):
        cdef str key = str(key_)
    ...
    def __contains__(self, item):
        return str(item) in self._cache
...
cdef class CacheMixin:
    ...
    cdef object _get_cached(self, object key):
        return self._cache.get_(str(key))

    cdef void _set_cached(self, object key, object value):
        self._cache.set_(str(key), value)